...
const DescriptionHome = () => {
    return (
        <motion.div initial="hidden" whileInView="show" viewport={{ once: false, amount: 0.25 }} variants={staggerContainer()} className="w-full max-w-[1200px] mx-auto pt-[60px] px-5 md:px-10">
            <Heading title="Mô tả về Korealift" />
            <motion.div variants={textVariant(0.75)}>
                <p className="text-indent mt-2">Korealift là một trang web học tiếng Hàn đa chức năng, nhằm giúp bạn tăng cường từ vựng, nắm vững ngữ pháp và chuẩn bị cho kỳ thi Toeic. Với một loạt các tính năng hữu ích, chúng tôi cam kết mang đến cho bạn một trải nghiệm học tập đáng nhớ.
                    Kho từ vựng đa dạng trên Korealift cho phép bạn khám phá và tìm hiểu các từ mới theo từng cấp độ. Từ điển chuyên sâu và đáng tin cậy giúp bạn tra cứu nhanh chóng và chính xác. Bạn cũng có thể tạo danh sách từ vựng cá nhân và thực hành với các bài tập tương ứng để ghi nhớ từ một cách hiệu quả.</p>
                ...
                <p className="text-indent mt-2">Korealift không chỉ là một trang web học tiếng Hàn thông thường, mà còn là một cộng đồng học tập năng động. Bạn có thể kết nối và trao đổi với các thành viên khác, thảo luận về các chủ đề liên quan đến tiếng Hàn và chia sẻ kinh nghiệm học tập của mình.</p>
            </motion.div>
        </motion.div>
    )
}
