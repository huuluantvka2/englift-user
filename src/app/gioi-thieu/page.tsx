...
const About = () => {
  return (
    <div className="w-full max-w-[1200px] mx-auto pt-[10px] px-5 md:px-10">
      ...
      <p className="text-indent mt-2">Phần mềm Web App học từ vựng tiếng anh <b>Englift</b> là một trong những Ứng dụng dùng để học từ vựng Tiếng Anh một cách hiệu quả nhất, giúp bạn học từ tựng một cách nhanh chóng, tiết kiệm thời gian học mà vẫn có thể nhớ được từ lâu nhất. Với kho từ vựng đồ sộ bao gồm audio, hình ảnh minh họa cho từ, các mẫu ví dụ liên quan đến từ vựng mà bạn đang học.</p>
